...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = `¡Bienvenido a la Calculadora Universidad! Soy tu asistente para cálculos rápidos.
        Puedes pedirme que sume, reste, multiplique o divida dos números, y también puedo ayudarte a calcular
        potencias y factoriales. Por ejemplo, puedes decir "¿Cuánto es 15 más 20?", "Divide 45 entre 9",
        "¿Cuánto es 2 elevado a la 3?" o "Calcula el factorial de 5". ¿Cómo puedo ayudarte hoy?`;
...
const CancelAndStopIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Gracias por usar la Calculadora Universidad. Espero haberte ayudado con tus cálculos. Si necesitas más ayuda, no dudes en volver a pedírmelo. ¡Hasta pronto y que tengas un excelente día!';
...
const FallbackIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Lo siento, no lo sé. Por favor, inténtelo de nuevo.';
